...
public class Deposit_with_non_existing_account_no {
	WebDriver driver;
	...
	@Test
	public void Deposit_with_non_existing_account_nos() throws InterruptedException {
		...
		AmountDepositPage.Account_No().sendKeys("11");
