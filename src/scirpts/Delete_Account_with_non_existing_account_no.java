...
public class Delete_Account_with_non_existing_account_no {
	...
	@Test
	public void Delete_Account_with_non_existing_account_nos() throws InterruptedException {
		...
		DeleteAccountPage.Account_No().sendKeys("11");
		...
		Assert.assertEquals("Account does not exist", message1);
	}
